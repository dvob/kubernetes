...
import (
	...
	"k8s.io/apiserver/plugin/pkg/authorizer/magic"
...
func (config Config) New() (authorizer.Authorizer, authorizer.RuleResolver, error) {
	...
	for _, authorizationMode := range config.AuthorizationModes {
		...
		case modes.ModeMagic:
			magicAuthorizer := magic.NewMagicAuthorizer()
			authorizers = append(authorizers, magicAuthorizer)
			ruleResolvers = append(ruleResolvers, magicAuthorizer)
		default:
